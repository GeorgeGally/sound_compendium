...
function SoundCloud(_fft) {
    ...
    var genres = ["deeptechno", "deepdisco","darkdisco", "indiedisco", "slomodisco", "slomohouse", "downtempotechno", "darktechno", "lowmotion", "minimalhouse", "acidhouse", "cosmic", "cosmicdisco"];
